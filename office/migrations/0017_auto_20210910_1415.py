# Generated by Django 3.0 on 2021-09-10 12:15
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('office', '0016_auto_20210908_1844'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='rates',
            name='AnalayticName',
            field=models.ManyToManyField(null=True, related_name='AnalayticName', to='office.FinicialAnalyst'),
        ),
        migrations.RemoveField(
            model_name='rates',
            name='CompanyEntered',
